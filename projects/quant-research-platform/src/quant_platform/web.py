...
from .study_web import register_study_routes
...
def create_app(
    ...
    *,
    ...
    register_study_routes(
        ...
        settings=settings,
        studies=studies,
        get_lightweight_studies=lambda: app.state.lightweight_studies,
        session_for=_session,
        verify_csrf=_csrf,
        load_json_body=_json_body,
        load_form_body=_form_body,
        render=_render,
        json_error=_json_error,
        json_text=_json_text,
        canonical_json_text=_canonical_json_text,
        study_from_form=_study_from_form,
        study_operator_groups=_study_operator_groups,
    )
