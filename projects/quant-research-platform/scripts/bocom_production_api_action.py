#!/usr/bin/env python3
"""Executable ailearn wrapper for the reviewed BOCOM production API job."""
...
if len(sys.argv) != 1:
    raise SystemExit("BOCOM production API action accepts no arguments")
...
raise SystemExit(client.main(["--job-id", "297c11cad0dc"]))
